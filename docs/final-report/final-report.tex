...
% TODO: expand on this and clarify places where I just mention "real-world data"
% how can i justify this though? use case and availability
...
\begin{itemize}
    \item limitation: API does not always give us the same text
...
\begin{itemize}
    \item limitations: These are noise types commonly present in digital text/articles. depending on the task at hand, OCR systems may face other types of noise, e.g. rotation, salt and pepper, lighting problems for real documents
\end{itemize}
