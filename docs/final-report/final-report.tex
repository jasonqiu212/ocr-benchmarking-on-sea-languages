...
\begin{table}[ht]
    \centering
    \caption{Average Character and Word Error Rate on real-world data}
...
\begin{itemize}
    \item from experiment 2
\end{itemize}

\subsection{Impact of Noise on OCR Accuracy}
