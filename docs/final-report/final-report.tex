...
We selected English, Indonesian, Vietnamese, and Thai text. 
...
% How can i better justify my choice of languages?

\subsection{Data Source}

This study collects textual data from Wikipedia for several reasons.
...
% better justify my choice for wikipedia
