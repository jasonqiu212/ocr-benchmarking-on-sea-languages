...
% clarify places where I just mention "real-world data"
...
\begin{itemize}
    \item OCR tools are actually pretty good at recognizing more complex Vietnamese and Thai scripts, contrary to what the overall CER rate implies
    \item contrary to what recent studies say too
    \item Importance of code switching in OCR
\end{itemize}
